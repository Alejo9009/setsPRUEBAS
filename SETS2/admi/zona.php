        ...
        <section class="login-content">
            <form action="recuperar.html" method="post" enctype="multipart/form-data">
                ...
                <div class="input-div one">
                    ...
                    <div class="div">
                        <h5>id Zona</h5>
                        <input type="text" name="idAnuncio" value="<?php echo htmlspecialchars($anuncio['idAnuncio'] ?? ''); ?>">
                ...
                <div class="input-div one">
                    ...
                    <div class="div">
                        <h5 class="input-title">descripcion</h5>
                        <input type="tetx" class="input" name="fecha" required>
                    </div>
                </div>
                <div class="input-div one">
