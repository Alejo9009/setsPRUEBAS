...
<div id="chatContainer" class="chat-container">
  ...
  <section class="anuncio">
    <center>
      <h2 style="color: rgb(11, 51, 21); text-align:center">Torres</h2>
    </center>
  </section>
      ...
      <div class="content">
        ...
        <div class="torre">
          ...
          <a href="pisos.html" class="content- button">
            <button class="add-announcement" style="text-decoration: none;">pisos</button>
          </a>
        </div>
      </div>
  ...
  <a href="inicioprincipal.html" class="btn btn-success" style="font-size: 30px;">VOLVER</a>
