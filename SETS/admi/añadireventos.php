...
<head>
    ...
    <title>SETS - Añadir Eventos</title>
    <link rel="stylesheet" href="css/anadireventos.css">
    ...
    <div class="container">
        <section class="login-content">
            <form action="recuperar.html" method="post">
                ...
                <div class="input-div one">
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-clock-fill" viewBox="0 0 16 16">
                ...
                <div class="input-div one">
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-calendar4-week" viewBox="0 0 16 16">
