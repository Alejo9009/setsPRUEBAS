...
<head>
    ...
    <title>SETS - actualizar-Piso</title>
    <link rel="stylesheet" href="css/actualizarapartamento.css">
    ...
    <div class="container">
        <section class="login-content">
            <form action="recuperar.html" method="post" enctype="multipart/form-data">
                <img src="img/apartamentos.png" alt="Logo" class="imgp">
                <h2 class="title">Actualizar Apartamento</h2>
                ...
                <div class="input-div one">
                    ...
                    <div class="div">
                        <h5>Numero Apartamento Nuevo</h5>
                ...
                <a href="pisos.html" class="btn small-btn" style="color: aliceblue;">VOLVER</a>
            </form>
        </section>
    </div>
