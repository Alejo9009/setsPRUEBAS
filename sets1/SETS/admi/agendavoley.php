...
<head>
    ...
    <title>SETS - solicitud cancha de VOLEYBALL</title>
    <link rel="stylesheet" href="css/agendavoley.css">
    ...
    <div class="container">
        <section class="login-content">
            <form action="recuperar.html" method="post" enctype="multipart/form-data">
                <img src="img/voll.png" alt="Logo" class="imgp">
                <h2 class="title">Solicitud Cancha  VOLEYBALL</h2>
                ...
                <div class="input-div one">
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-calendar2-week" viewBox="0 0 16 16">
