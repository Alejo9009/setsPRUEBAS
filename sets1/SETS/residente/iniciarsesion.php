                ...
                <form action="login.php" method="post">
                    ...
                    <section class="input-div mb-3 d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <input type="text" class="form-control" name="usuario" required style="color: #12460d;">
                        </div>
                    </section>
                    <section class="input-div mb-4 d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <input type="password" class="form-control" name="clave" required style="color: #12460d;">
                        </div>
                    </section>
