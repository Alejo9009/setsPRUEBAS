...
<body>
    ...
    <main>
            ...
            <div class="container">
                    ...
                    <section class="icons">
                        <div class="icon">
                            <a href="torres.html" class="link-button">
                        ...
                        <div class="icon">
                            <a href="datos_usuario.html" class="link-button">
    ...
    <section class="announcements">
        ...
        <img src="<?= htmlspecialchars($row['img_anuncio']); ?>" alt="Imagen del video" style="width:100%; max-width:100px;">
            ...
            <?php if ($isEvent) { ?>
            <div class="icon">
                <a href="eventosregistro.php?id=<?php echo urlencode($row['idAnuncio']); ?>" class="link-button">
        ...
        <div class="icon">
            <a href="index.php" class="link-button">
                <button class="add-announcement"> Anuncio</button>
            </a>
        </div>
    </section>
</div>
